...
1) Accidents are more frequent during Winter periods. [view](jupyter_notebooks/07_Hypothesis_Testing_Temporal_Data.ipynb) 
2) Accidents are more frequent during non-dry weather conditions. [view](jupyter_notebooks/04_EDA_Advanced.ipynb) (jupyter_notebooks/03_EDA_Basic.ipynb)
