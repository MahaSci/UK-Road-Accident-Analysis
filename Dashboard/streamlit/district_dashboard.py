...
st.markdown("This dashboard shows key trends and patterns district-wise in traffic accidents, helping to identify areas for improvement and safety measures.")
